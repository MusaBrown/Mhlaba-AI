#!/usr/bin/env python3
"""
JARVIS - Working Voice Version (Uses subprocess for speech)
"""
...
print("="*60)
print("JARVIS - WORKING VOICE EDITION")
print("="*60)
...
def speak(text):
    """Speak text using subprocess (reliable method)"""
    global USER_NAME
    ...
    try:
        # Create a temporary speech script
        script = f'''
import pyttsx3
engine = pyttsx3.init()
...
engine.runAndWait()
'''
        # Run speech in separate process
